...
namespace Gordon360.Static.Names
{
    ...
    public static class SQLQuery
    {
        ...
        public static string ALL_PUBLIC_FACULTY_STAFF_REQUEST = "SELECT ISNULL(FirstName, '') as FirstName, ISNULL(LastName, '') as LastName, ISNULL(NickName, '') as NickName, ISNULL(OnCampusDepartment, '') as OnCampusDepartment, ISNULL(BuildingDescription, '') as BuildingDescription, ISNULL(HomeCity, '') as HomeCity, ISNULL(HomeState, '') as HomeState, ISNULL(Country, '') as Country, KeepPrivate, ISNULL(JobTitle, '') as JobTitle, ISNULL(Email, '') as Email, ISNULL(Type, '') as Type, ISNULL(Mail_Location, '') as Mail_Location, AD_Username FROM FacStaff WHERE AD_Username is not null FOR JSON PATH, ROOT('FacStaff')";
        public static string ALL_PUBLIC_ALUMNI_REQUEST = "SELECT ISNULL(FirstName, '') as FirstName, ISNULL(LastName, '') as LastName, ISNULL(NickName, '') as NickName, ISNULL(Major1Description, '') as Major1Description, ISNULL(Major2Description, '') as Major2Description, ISNULL(HomeCity, '') as HomeCity, ISNULL(HomeState, '') as HomeState, ISNULL(Country, '') as Country, ISNULL(Email, '') as Email, ISNULL(ShareName, '') as ShareName, ISNULL(PreferredClassYear, '') as PreferredClassYear, ISNULL(AD_Username, '') as AD_Username FROM Alumni WHERE AD_Username is not null AND ShareName is null OR ShareName = 'Y'  FOR JSON PATH, ROOT('Alumni');";
